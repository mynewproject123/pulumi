...
function getPulumiComponents(moduleExports) {
    ...
    function getComponents(value) {
        ...
        if (typeof value === "function" && value.prototype) {
            ...
            while (proto === null || proto === void 0 ? void 0 : proto.__proto__) {
...
class ComponentProvider {
    ...
    getSchema() {
        return __awaiter(this, void 0, void 0, function* () {
            const analyzer = new analyzer_1.Analyzer(this.path, this.packageJSON, new Set(Object.keys(this.componentConstructors)));
